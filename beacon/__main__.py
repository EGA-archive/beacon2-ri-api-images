...
def main(path=None):
    ...
    beacon = web.Application(
        middlewares=[web.normalize_path_middleware(), middlewares.error_middleware, cors_middleware(origins=["https://beacon-network-test.ega-archive.org", "https://beacon-network-test2.ega-archive.org", "https://beacon-network-demo.ega-archive.org","https://beacon-network-demo2.ega-archive.org", "http://localhost:3003", "http://localhost:3004", "http://localhost:3001", "https://beacon-network-cineca-demo.ega-archive.org", "https://beacon-cancer-registry-test.ega-archive.org/"])]
    )
