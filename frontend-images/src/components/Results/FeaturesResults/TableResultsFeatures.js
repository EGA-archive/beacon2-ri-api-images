...
function TableResultsFeatures(props) {
    ...
    const columns = [
        ...
        { field: 'imaging_feature_domain_id_measurement_id', headerName: 'measurement_id', flex: 1, headerClassName: 'table-header' },
        ...
        { field: 'imaging_feature_domain_id_concept_class_id', headerName: 'concept_class_id', flex: 1, headerClassName: 'table-header' },
        { field: 'imaging_feature_domain_id_concept_code', headerName: 'concept_code', flex: 1, headerClassName: 'table-header' },
        { field: 'imaging_feature_domain_id_concept_id', headerName: 'concept_id', flex: 1, headerClassName: 'table-header' },
        { field: 'imaging_feature_domain_id_concept_name', headerName: 'concept_name', flex: 1, headerClassName: 'table-header' },
        { field: 'imaging_feature_domain_id_operator_concept_id', headerName: 'operator_concept_id', flex: 1, headerClassName: 'table-header' },
        { field: 'imaging_feature_domain_id_operator_concept_name', headerName: 'operator_concept_name', flex: 1, headerClassName: 'table-header' },
        { field: 'imaging_feature_domain_id_domain_id', headerName: 'domain_id', flex: 1, headerClassName: 'table-header' },
        { field: 'imaging_feature_domain_id_value_as_number', headerName: 'value_as_number', flex: 1, headerClassName: 'table-header' },
        { field: 'imaging_feature_domain_id_measurement_source_concept_id', headerName: 'measurement_source_concept_id', flex: 1, headerClassName: 'table-header' },
        { field: 'imaging_feature_domain_id_standard_concept', headerName: 'standard_concept', flex: 1, headerClassName: 'table-header' },
        { field: 'imaging_feature_domain_id_measurement_type_concept_id', headerName: 'measurement_type_concept_id', flex: 1, headerClassName: 'table-header' },
        { field: 'imaging_feature_domain_id_measurement_type_concept_name', headerName: 'measurement_type_concept_name', flex: 1, headerClassName: 'table-header' },
        { field: 'imaging_feature_domain_id_vocabulary_id', headerName: 'vocabulary_id', flex: 1, headerClassName: 'table-header' },
        { field: 'imaging_feature_domain_id_person_id', headerName: 'person_id', flex: 1, headerClassName: 'table-header' },
        { field: 'imaging_feature_domain_id_measurement_date', headerName: 'measurement_date', flex: 1, headerClassName: 'table-header' },
        { field: 'imaging_feature_domain_id_measurement_datetime', headerName: 'measurement_datetime', flex: 1, headerClassName: 'table-header' },
        { field: 'imaging_feature_domain_id_measurement_time', headerName: 'measurement_time', flex: 1, headerClassName: 'table-header' },
        { field: 'imaging_feature_domain_id_measurement_source_value', headerName: 'measurement_source_value', flex: 1, headerClassName: 'table-header' },
        ...
        initialState={{
            columns: {
              columnVisibilityModel: {
                ...
                anatomic_site_concept_id_concept_id: false,
