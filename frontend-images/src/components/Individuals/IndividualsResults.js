...
function IndividualsResults(props) {
    ...
    const API_ENDPOINT = "http://localhost:5054/api/individuals/"
        ...
        const apiCall = async () => {
            ...
            try {
                ...
                if (props.query === null) {
                    ...
                    res = await axios.post("http://localhost:5054/api/individuals", jsonData1)
                    ...
                    res = await axios.post("http://localhost:5054/api/individuals", jsonData2)
                    console.log(res)
                    setTimeOut(true)
