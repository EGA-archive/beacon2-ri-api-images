...
import TableResultsConditions from '../Results/ConditionsResults/TableResultsConditions';

import configData from '../../config.json'

function ConditionsResults(props) {
    ...
    const API_ENDPOINT = configData.API_URL + "/api/conditions"
        ...
        const apiCall = async () => {
            ...
            try {
                ...
                if (props.query === null) {
                    ...
                    //res = await axios.post("https://beacons.bsc.es/beacon-network/v2.0.0/Conditions/", jsonData1, { headers: headers })
                    res = await axios.post(API_ENDPOINT, jsonData1)

                    // res = await axios.post("http://localhost:5050/api/Conditions", jsonData1, { headers: headers })
                    console.log(res)
                    setTimeOut(true)
                ...
                <div>
                    ...
                    <div> {timeOut &&
                        ...
                        {show3 && !error && <div>
                            ...
                            <TableResultsConditions results={results} ></TableResultsConditions>
                        </div>}
