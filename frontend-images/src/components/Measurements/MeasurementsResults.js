...
import TableResultsMeasurements from '../Results/MeasurementsResults/TableResultsMeasurements';

import configData from '../../config.json'

function MeasurementsResults(props) {
    ...
    const API_ENDPOINT = configData.API_URL + "/api/measurements"
        ...
        const apiCall = async () => {
            ...
            try {
                ...
                if (props.query === null) {
                    ...
                    //res = await axios.post("https://beacons.bsc.es/beacon-network/v2.0.0/Measurements/", jsonData1, { headers: headers })
                    res = await axios.post(API_ENDPOINT, jsonData1)

                    // res = await axios.post("http://localhost:5050/api/Measurements", jsonData1, { headers: headers })
                    console.log(res)
                    setTimeOut(true)
                ...
                <div>
                    ...
                    <div> {timeOut &&
                        ...
                        {show3 && !error && <div>
                            ...
                            <TableResultsMeasurements results={results} ></TableResultsMeasurements>
                        </div>}
